...
public:
	...
	virtual void	ForcedMaterialOverride(IMaterial* newMaterial, int nOverrideType = 0) = 0;
	...
	virtual void AddDecal(ModelInstanceHandle_t handle, Ray_t const& ray,
		Vector const& decalUp, int decalIndex, int body, bool noPokeThru, int maxLODToDecal) = 0;
