...
public:
	...
	virtual void SetVoiceCasterID(unsigned int id) = 0;
#endif
	...
	virtual int			GetFrustrumList(Frustrum_t** pList, int listMax) = 0;
	virtual bool		ShouldUseAreaFrustrum(int i) = 0;
	...
	virtual int			GetOcclusionViewId(void);
	...
	virtual void		UnknownFunc000(void) = 0;
	...
	virtual int  GetInputContext(int /*EngineInputContextId_t*/ id) = 0;
